...
public final class MessagingExceptionMessages {
    ...
    public static final String OUTBOX_PAYLOAD_MUST_BE_JSON_SERIALIZABLE =
        "아웃박스 페이로드는 JSON으로 직렬화할 수 있어야 합니다";
    public static final String IN_PROCESS_EVENT_PAYLOAD_MUST_BE_JSON_SERIALIZABLE =
        "인프로세스 이벤트 페이로드는 JSON으로 직렬화할 수 있어야 합니다";
