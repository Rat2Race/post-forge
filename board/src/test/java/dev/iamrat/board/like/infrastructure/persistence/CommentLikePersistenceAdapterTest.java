...
class CommentLikePersistenceAdapterTest {
    ...
    @Test
    @DisplayName("existsByCommentIdAndAccountId는 Spring Data 저장소에 위임한다")
    ...
    @Test
    @DisplayName("count와 delete는 Spring Data 저장소에 위임한다")
    ...
    @Test
    @DisplayName("일괄 조회는 Spring Data 저장소에 위임한다")
