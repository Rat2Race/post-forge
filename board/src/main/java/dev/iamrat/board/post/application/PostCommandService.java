...
public class PostCommandService {
    ...
    @Transactional
    public PostSummaryResult savePost(String title, String content, Long accountId, List<Long> fileIds) {
        return savePost(title, content, null, null, PostCategory.GENERAL, accountId, fileIds);
    }

    @Transactional
    public PostSummaryResult savePost(
        String title,
        String content,
        String summary,
        List<String> tags,
        ...
        return PostSummaryResult.from(newPost);
    }

    @Transactional
    public PostSummaryResult updatePost(Long postId, String title, String content, List<Long> fileIds) {
        return updatePost(postId, title, content, null, null, PostCategory.GENERAL, fileIds);
    }

    @Transactional
    public PostSummaryResult updatePost(
        Long postId,
        String title,
        String content,
        String summary,
        ...
        return PostSummaryResult.from(post);
    }
