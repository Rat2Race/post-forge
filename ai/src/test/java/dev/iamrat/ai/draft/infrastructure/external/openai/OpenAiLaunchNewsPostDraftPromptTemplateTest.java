package dev.iamrat.ai.draft.infrastructure.external.openai;
...
class OpenAiLaunchNewsPostDraftPromptTemplateTest {
    ...
    private final OpenAiLaunchNewsPostDraftPromptTemplate promptTemplate =
        new OpenAiLaunchNewsPostDraftPromptTemplate(new PromptTemplateLoader());
