...
public class PostDraftGenerationService {
    ...
    public PostDraftResult generate(PostDraftGenerateCommand request) {
        ...
        return new PostDraftResult(title, content, summary, tags, category);
    }

    private String userPrompt(PostDraftGenerateCommand request) {
        return """
            주제 또는 요청:
            %s
    ...
    private String deriveTitle(PostDraftGenerateCommand request, String content) {
