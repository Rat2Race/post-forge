...
public class TrackedKeywordService {
    ...
    @Transactional
    public TrackedKeyword register(SourceType source, String keyword, Integer displayCount) {
        ...
        return trackedKeywordRepository.findBySourceAndKeyword(effectiveSource, normalizedKeyword)
            .orElseGet(() -> trackedKeywordRepository.save(
                TrackedKeyword.register(effectiveSource, normalizedKeyword, displayCount)
            ));
    }
