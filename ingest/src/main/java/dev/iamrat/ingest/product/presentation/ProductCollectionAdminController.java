...
public class ProductCollectionAdminController {
    ...
    public ResponseEntity<TrackedKeywordResponse> registerKeyword(
        @RequestBody @Valid ProductCollectionTargetRequest request
    ) {
    ...
    public ResponseEntity<List<TrackedKeywordResponse>> getTrackedKeywords() {
    ...
    public ResponseEntity<CollectionJobResponse> collectProducts(
        @RequestBody @Valid ProductCollectionTargetRequest request
    ) {
    ...
    public ResponseEntity<PageResponse<CollectionJobResponse>> getCollectionJobs(
        @PageableDefault(size = 20, sort = "requestedAt", direction = Sort.Direction.DESC) Pageable pageable
    ) {
        Page<CollectionJobResponse> jobs = collectProductsUseCase.getCollectionJobs(pageable)
            .map(CollectionJobResponse::from);
