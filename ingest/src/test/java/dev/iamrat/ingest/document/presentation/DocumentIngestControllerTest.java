...
class DocumentIngestControllerTest {
    ...
    @Test
    @DisplayName("content가 공백인 요청은 400으로 거절한다")
    void ingest_rejectsBlankContentWithBadRequest() throws Exception {
        List<DocumentIngestRequest> requests = List.of(new DocumentIngestRequest(
            " ",
            "manual",
            Map.of("keyword", "tech")
        ));
